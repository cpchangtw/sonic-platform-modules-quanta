...
//Define GPIO Base(Migrate from ONL)
...
static struct gpio_led system_led[] = {
#if defined(QUANTA_CPU_RGL)
	{
		...
		.gpio = (QUANTA_IX2_I2C_GPIO_CPU_BASE + 10),
		.active_low = 0,
	},
	{
		.name = "sysled_green",
		.gpio = (QUANTA_IX2_I2C_GPIO_CPU_BASE + 11),
		.active_low = 0,
	},
#endif
	{
		.name = "front_led_psu1_green",
		.gpio = (QUANTA_IX2_PSU_GPIO_BASE + 10),
		.active_low = 0,
	},
	{
		.name = "front_led_psu1_red",
		.gpio = (QUANTA_IX2_PSU_GPIO_BASE + 11),
		.active_low = 0,
	},
	{
		.name = "front_led_psu2_green",
		.gpio = (QUANTA_IX2_PSU_GPIO_BASE + 12),
		.active_low = 0,
	},
	{
		.name = "front_led_psu2_red",
		.gpio = (QUANTA_IX2_PSU_GPIO_BASE + 13),
		.active_low = 0,
	},
	{
		.name = "front_led_fan_green",
		.gpio = (QUANTA_IX2_PSU_GPIO_BASE + 14),
		.active_low = 0,
	},
	{
		.name = "front_led_fan_red",
		.gpio = (QUANTA_IX2_PSU_GPIO_BASE + 15),
		.active_low = 0,
	},
	{
		.name = "rear_led_fan1_red",
		.gpio = (QUANTA_IX2_FAN_GPIO_BASE + 12),
		.active_low = 0,
	},
	{
		.name = "rear_led_fan2_red",
		.gpio = (QUANTA_IX2_FAN_GPIO_BASE + 13),
		.active_low = 0,
	},
	{
		.name = "rear_led_fan3_red",
		.gpio = (QUANTA_IX2_FAN_GPIO_BASE + 14),
		.active_low = 0,
	},
	{
		.name = "rear_led_fan4_red",
		.gpio = (QUANTA_IX2_FAN_GPIO_BASE + 15),
		.active_low = 0,
	},
};
